export const accountTypesDefaultValues = {
  ...
  saving: {type:'saving', longType: 'Term Saving', nativeDebitCredit: true, liquidityScore: 950 ,effectiveDate:true,simpleAnnualInterest:true,term:true,interestPaymentFrequency:true,probabilityOfDefault:true,percentLossGivenDefault:true,sort:20},
  stock: {type:'stock', longType: 'Stock', nativeDebitCredit: true,liquidityScore: 800 ,effectiveDate:true,sort:25},
  bond: {type:'bond', longType: 'Bond', nativeDebitCredit: true, liquidityScore: 500 ,effectiveDate:true,simpleAnnualInterest:true,term:true,interestPaymentFrequency:true,probabilityOfDefault:true,percentLossGivenDefault:true,sort:30},
  gold: {type:'gold', longType: 'Gold', nativeDebitCredit: true,liquidityScore: 750 ,effectiveDate:true,sort:35},
  foreign: {type:'foreign', longType: 'Foreign Currency', nativeDebitCredit: true, liquidityScore: 800 ,effectiveDate:true,sort:37},
  insurance: {type:'insurance', longType: 'Insurance', nativeDebitCredit: true,liquidityScore: 1 ,effectiveDate:true,premiumPayment:true,premiumDuration:true,protectionValue:true,protectionDuration:true,sort:40},  
